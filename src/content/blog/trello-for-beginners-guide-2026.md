---
title: "Trello for Beginners: Complete Getting Started Guide (2026)"
...
Click the "+" button in the top navbar and select "Create board." Choose a background color or image. Name it something specific — "2026 Blog Calendar" is better than "Work."

**Step 2: Add your lists**
Delete the default lists if you don't like them. For a simple task board, start with:
...
Click "+ Add a card" at the bottom of any list. Type the task name and press Enter. Add more cards until you've captured everything.

**Step 4: Fill in card details**
Click on a card to open it. Add:
...
→ [Trello pricing 2026](/blog/trello-pricing-2026/) | [Trello free vs paid](/blog/trello-free-vs-paid-2026/)
