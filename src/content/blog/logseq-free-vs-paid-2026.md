---
title: "Logseq Free vs Paid: What Do You Actually Get?"
...
| Feature | Free | Sync ($5/mo) | Sponsor ($15/mo) |
|---------|------|-------------|-------------------|
| Full outliner + bidirectional links | Yes | Yes | Yes |
| Graph view | Yes | Yes | Yes |
| Plugins + themes | Yes | Yes | Yes |
| PDF annotation | Yes | Yes | Yes |
| Flashcards | Yes | Yes | Yes |
| Custom queries | Yes | Yes | Yes |
| Cloud sync | No | Yes | Yes |
| Mobile access | No | Yes | Yes |
| E2E encrypted backups | No | Yes | Yes |
...
For a detailed [Logseq pricing](/blog/logseq-pricing-2026) breakdown including annual billing discounts and team options, we've covered that separately.
...
If you're evaluating alternatives, our guide to the [best Logseq alternatives](/blog/best-logseq-alternatives-2026) covers other tools in this space.

Compare Logseq and Obsidian side by side → [Logseq vs Obsidian](/compare/logseq-vs-obsidian/)
