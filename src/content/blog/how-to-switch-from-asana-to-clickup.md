...
2. Click your avatar → **Settings** → **Import/Export**
3. Select **Asana** from the import options
4. Authenticate with your Asana account
5. Select which projects to import
6. Map your Asana projects to ClickUp Spaces/Folders
7. Start the import
...
Start with one team or project. Iron out issues before going organization-wide.

**2. Not mapping custom fields**
Asana custom fields need to be recreated in ClickUp before import. Plan this ahead.

**3. Ignoring the hierarchy difference**
