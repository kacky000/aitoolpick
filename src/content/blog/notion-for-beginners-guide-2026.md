---
title: "Notion for Beginners: Complete Getting Started Guide (2026)"
...
- `/text` — a text block (the default)
- `/h1`, `/h2`, `/h3` — headings
- `/bullet` — a bulleted list
- `/to-do` — a checkbox (great for tasks)
- `/image` — an image upload
- `/database` — opens the database options
...
→ [Notion pricing 2026](/blog/notion-pricing-2026/) | [Notion free vs paid](/blog/notion-free-vs-paid-2026/)
